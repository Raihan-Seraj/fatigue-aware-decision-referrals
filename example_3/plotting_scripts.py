...
def create_performance_table(betas,alphas, gammas,num_tasks_per_batch, result_path):
	...
	for beta in betas:
		...
		for alpha in alphas:
			...
			for gamma in gammas:
				...
				new_row  = pd.DataFrame([[beta,alpha, gamma, 
...
if __name__=='__main__':
	...
	create_performance_table(betas,alphas, gammas, num_tasks_per_batch, result_path)