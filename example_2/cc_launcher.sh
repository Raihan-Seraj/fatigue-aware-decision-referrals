...
do
    ...
    do
        ...
        do
            ...
            echo "#SBATCH --time=06:00:00" >> temprun.sh
            ...
            echo "python approximate_dp.py --alpha ${alpha} --mu ${mu} --lamda ${lamda} --num_expectation_samples 200 --num_eval_runs 500" >> temprun.sh
