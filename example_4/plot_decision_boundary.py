...
def plot_decision_boundary(args):
    ...
    if plot_posterior:
        ...
        mega_obs_path = args.results_path+'/num_tasks '+str(args.num_tasks_per_batch)+'/beta '+str(args.beta)+'/alpha '+str(args.alpha)+'mu_'+str(args.mu)+'_lambda_'+str(args.lamda)+'plot_analysis/cost_comparison/all_mega_batch.pkl'
