...
class Evaluations(object):
    def __init__(self,args):
        ...
        if self.args.use_wandb:
            self.run_info = wandb.init(project="Example 1",settings=wandb.Settings(start_method="fork"),mode=self.args.wandb_sync)
    ...
    def compute_perf_multiprocess(self):
        ...
        if self.args.use_wandb:
            self.run_info.name= "beta "+str(self.args.beta)+' mu '+str(self.args.mu)+' lambda '+str(self.args.lamda)

        print("Computing peformance with beta = "+str(self.args.beta)+'\n')

        param_path = self.args.results_path + 'num_tasks '+str(self.args.num_tasks_per_batch)+'/beta '+str(self.args.beta)+'/mu_'+str(self.args.mu)+'_lambda_'+str(self.args.lamda)+'/params.json'
        ...
        V_bar = np.load(self.args.results_path + 'num_tasks '+str(self.args.num_tasks_per_batch)+'/beta '+str(self.args.beta)+'/mu_'+str(self.args.mu)+'_lambda_'+str(self.args.lamda)+'/V_bar.npy')
        ...
        path1 = self.args.results_path + 'num_tasks '+str(self.args.num_tasks_per_batch)+'/beta '+str(self.args.beta)+'/mu_'+str(self.args.mu)+'_lambda_'+str(self.args.lamda)+'/plot_analysis/cost_comparison/'
    ...
    def run_perf_eval(self):
        ...
        path_name = self.args.results_path+ 'num_tasks '+str(self.args.num_tasks_per_batch)+'/beta '+str(self.args.beta)+'/mu_'+str(self.args.mu)+'_lambda_'+str(self.args.lamda)+'/plot_analysis/'
